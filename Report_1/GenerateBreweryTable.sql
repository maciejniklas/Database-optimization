...
BEGIN
  ...
  FOR i IN 1..1500 LOOP
    INSERT INTO Brewery(breweryName) VALUES (
        (SELECT LISTAGG(tempValue, ' ') WITHIN GROUP (ORDER BY tempOrder ASC) FROM (
...
/* PURGE RECYCLE BIN */
PURGE TABLE TempCompany;
PURGE TABLE TempColor;
PURGE TABLE TempItem;